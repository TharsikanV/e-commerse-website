    ...
    class BlogMember extends BlogReader
    {
        ...
        public function sendemail_verify($verify_token)
        {
            ...
            $email_templete="
                    ...
                    <br/><br/>
                     <a href='http://localhost/finalProject-master/verify-email.php?token=$verify_token'>Click Here to verify</a>
        ...
        public function send_password_reset($get_email,$get_name,$token)
        {
            ...
            $email_templete="
                    ...
                    <br/><br/>
                     <a href='http://localhost/finalProject-master/password-change.php?token=$token&email=$get_email'>Click Here to verify</a>
        ...
        public function sendemail_to_customer()
        {
            ...
            $email_templete="
                    ...
                    <br/><br/>
                     <a href='http://localhost/finalProject-master/login.php'>Click Here to check your order </a>
