...
?>    
    ...
    <body>
        ...
        <nav>
            <div class="nav-left">
            <h3 class="logo">LUCKY <br> Mobiles</h3>
            <ul id="sidemenu" class="navLinks">
                <li>
                <?php
            ...
            <div><i class="fas fa-bars" onclick="openmenu()"></i></div>
   ...
   <div class="searchBar">
      <input type="text" class="search-bar" id="search-bar" placeholder="What are you looking for?" required onkeyup="search()">
